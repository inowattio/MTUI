...
use crate::num_ops::{digit_add, digit_add_option, digit_remove, digit_remove_option, negate_opt_option};
    ...
    match key_event.code {
        ...
        KeyCode::Char(c) => {
            if c.is_ascii_digit() {
                ...
                match &mut app.state {
                    ...
                    State::Jump(params) => digit_add_option(&mut params.to, digit),
        ...
        KeyCode::Backspace => {
            match &mut app.state {
                ...
                State::Jump(params) => digit_remove_option(&mut params.to),
