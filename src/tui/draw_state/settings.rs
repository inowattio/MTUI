...
fn field_value(
    ...
    match field {
        ...
        SettingsField::ThemeSeries1 => color_view(device.theme.series_1),
        SettingsField::ThemeSeries2 => color_view(device.theme.series_2),
        SettingsField::ThemeSeries3 => color_view(device.theme.series_3),
